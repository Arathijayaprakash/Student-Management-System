<h2 style="color:#007bff; margin-bottom:20px;">Add Teacher</h2>

<form method="POST" action="/teachers/add" style="
    background:white;
    padding:20px;
    border-radius:8px;
    max-width:500px;
...
">
    ...
    <div style="margin-bottom:15px;">
        ...
        <input type="phone" name="phone" required style="
            width:100%;
            padding:10px;
            border:1px solid #ccc;
            border-radius:5px;
    ...
    <div style="margin-bottom:15px;">
        ...
        <input type="qualification" name="qualification" required style="
            width:100%;
            padding:10px;
            border:1px solid #ccc;
            border-radius:5px;
